...
function buildSystemInstruction(role, sources) {
    ...
    return [
        ...
        "- Catalog dùng products.price thang nghìn đồng (khung ~1.690–9.490; '3 triệu' ≈ 3000, KHÔNG dùng 3000000).",
        "- 'dưới X triệu / khoảng giá': min_price/max_price theo thang nghìn đồng (ví dụ dưới 3 triệu → max_price=3000) + sort_by=price_asc.",
        ...
        "- Liệt kê sản phẩm: tên · SKU · giá (thang nghìn đồng, formatCurrency) · tồn.",
